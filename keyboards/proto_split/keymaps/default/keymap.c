...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,\
    KC_TCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,\
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_RSLS, KC_RSFT,\
         KC_LALT,   KC_NO,   LOWER,   KC_LGUI, KC_LSPC,       KC_LSPC, KC_RALT, RAISE,   KC_NO,   ADJUST \
),
    [_GAME] = LAYOUT(\
    KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_BSPC,\
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,   KC_ENT,\
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_LGUI, KC_RSFT,\
         KC_NO,    KC_NO,   LOWER,   KC_ENT,  KC_SPC,       G_RAISE, KC_RALT, RAISE,    KC_NO,   ADJUST \
),
  [_LOWER] = LAYOUT( \
    KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10, KC_DEL,\
    ...
    _______, KC_BTN2, KC_BSPC, KC_APP,  KC_ENT, KC_F12,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,\
         _______, KC_NO,   LOWER,   _______, KC_TAB,           KC_TAB, _______,RAISE,   KC_NO,   ADJUST\
   ),
  [_RAISE] = LAYOUT( \
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,      KC_9,      KC_0,    KC_GRV,\
    _______, KC_4,    KC_5,    KC_6,    KC_DOT,  XXXXXXX, KC_LBRC, KC_MINS, KC_EQL,    KC_BSLS,   KC_LPRN, KC_QUOT,\
    _______, KC_7,    KC_8,    KC_9,    KC_0,    XXXXXXX, KC_RBRC, KC_SCLN, XXXXXXX,   XXXXXXX,   KC_RPRN, _______,\
         _______,   KC_NO,   LOWER,   _______, KC_TAB,          XXXXXXX, _______, RAISE,   KC_NO,  _______\
  ),
  [_G_RAISE] = LAYOUT( \
    ...
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_0,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RPRN, _______,\
         KC_NO,   KC_NO,   LOWER,   _______, KC_TAB,          XXXXXXX, _______, RAISE,   KC_NO,   _______\
  ),
  [_ADJUST] = LAYOUT( \
    RESET,DF(_QWERTY),XXXXXXX, EEP_RST, XXXXXXX, XXXXXXX, EEP_RST, XXXXXXX, KC_PSCR, KC_UP,   XXXXXXX, XXXXXXX,\
    ...
    _______, XXXXXXX, CK_RST,  CK_UP,   CK_DOWN,BL_TOGG,  BL_BRTG, BL_DEC,  XXXXXXX, KC_DOWN, XXXXXXX, _______,\
         _______, KC_NO,   LOWER,   _______, XXXXXXX,          XXXXXXX, _______, RAISE,   KC_NO,   _______\
  ), \
};
